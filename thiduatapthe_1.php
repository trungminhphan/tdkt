...
$donvi = new DonVi();$nam = new Nam();$danhhieu = new DanhHieu();
    ...
    <div class="col-md-12">
        <div class="panel panel-danger">
            <div class="panel-heading">
                ...
                <h4 class="panel-title"><i class="fa fa-list"></i> Xét duyệt thi đua tập thể vòng 1</h4>
            </div>
                ...
                <table id="data-table" class="table table-striped table-bordered table-hovered">
                    ...
                    if($thidua_list){
                        ...
                        foreach($thidua_list as $td){
                            ...
                            echo '<td class="text-center"><a href="get.thiduatapthe.html?id='.$td['_id'].'&act=xetduyet_1#modal-xetduyet" data-toggle="modal" class="xetduyet">'.$arr_tinhtrang[$t].'</a></td>';
                            echo '</tr>'; $i++;
                        }
                    }
                    ?>
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title">XÉT DUYỆT ĐĂNG KÝ THI TẬP THỂ NHÂN VÒNG 1</h4>
                </div>
