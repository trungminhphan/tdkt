...
$sangkienkinhnghiem = new SangKienKinhNghiem();$nhansu = new NhanSu();
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title">Thông tin sán kiến kinh nghiệm</h4>
            </div>
            <div class="modal-body">
                ...
                <div class="form-group">
                    <div class="col-md-12">
                        <select name="id_nhansu[]" multiple="multiple" class="select2" style="width:100%">
                        <?php
                        if($nhansu_list){
