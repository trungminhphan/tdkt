            ...
            <div class="right-content">
                ...
                <div class="login-header">
                    <div class="brand">
                        ...
                        <small>HỆ THỐNG QUẢN LÝ THI ĐUA KHEN THƯỞNG</small>
                    </div>
                    <div class="icon">
                ...
                <div class="login-content">
                    <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="POST" class="margin-bottom-0" id="loginform">
                        ...
                        <div class="login-buttons">
                            <button type="submit" name="submit" id="submit" class="btn btn-danger btn-block btn-lg">Đăng nhập hệ thống</button>
                        </div>
                        <hr />
                    </form>
                </div>
